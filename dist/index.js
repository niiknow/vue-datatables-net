...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return {
      options: {
        dom: '<\'row\'<\'col-sm-12 col-md-4\'l><\'text-right col-sm-12 col-md-6\'B><\'col-sm-12 col-md-2\'f>>' + '<\'row\'<\'col-sm-12\'tr>>' + '<\'row\'<\'col-sm-12 col-md-5\'i><\'col-sm-12 col-md-7\'p>>',
        columns: [],
        buttons: [] // remove any button defaults
      },
      dataTable: null
    ...
    $el.on('click', '[data-action]', function (e) {
      ...
      if (action) {
        ...
        if (tr) {
          ...
          var data = row.data();
          vm.$emit(action, { data: data, row: row, that: that });
        } else {
          // not a row click, must be other kind of action
          // such as bulk, csv, pdf, etc...
          vm.$emit(action, { target: target });
        }
      }
    });
  }
...
var render = function() {
  ...
  return _c("div", { staticClass: "vdtnet-container" }, [
    _c(
      "div",
      { staticClass: "container-fluid vdtnet-head" },
      [_vm._t("HEAD")],
      2
    ),
    _vm._v(" "),
    _c("div", { staticClass: "vtdnet-body" }, [_vm._m(0)]),
    _vm._v(" "),
    _c(
      "div",
      { staticClass: "container-fluid vdtnet-foot" },
      [_vm._t("FOOT")],
      2
    )
  ])
