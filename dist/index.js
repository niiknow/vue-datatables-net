...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return {
      options: {
        /*eslint-disable */
        dom: "<'row'<'col-sm-12'tr>>" + "<'row vdtnet-footer'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'pl>>",
        /*eslint-enable */
        columns: [],
        language: {
          infoFiltered: ''
  ...
  methods: {
    ...
    reload: function reload() {
      ...
      var vm = this;
      var callback = vm.dataTable.ajax.reload(callback, resetPaging);

      if (vm.dataLoader) {
        // manual data loading
        var p = vm.getServerParams();
        vm.dataLoader(p, function (data) {
          if (data && !data.data) {
            data = { data: data };
          }
          vm.setTableData(data.data);
...
var render = function() {
  ...
  return _c("div", { staticClass: "vdtnet-container" }, [_vm._m(0)])
}
var staticRenderFns = [
  function() {
    var _vm = this
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!./select.bootstrap4.min.css", function() {
			var newContent = require("!!../../css-loader/index.js!./select.bootstrap4.min.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!./buttons.bootstrap4.min.css", function() {
			var newContent = require("!!../../css-loader/index.js!./buttons.bootstrap4.min.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!./responsive.bootstrap4.min.css", function() {
			var newContent = require("!!../../css-loader/index.js!./responsive.bootstrap4.min.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("ul", [
      _c("li", [
        _vm._v(
          "Select Checkbox is on 2nd column to prevent conflict with responsive."
        )
      ]),
      _vm._v(" "),
      _c("li", [
        _vm._v(
          "Responsive also has conflict with custom master/details implementation because, by default, it use the jQuery DataTables child function.  Therefore, it's probably best to use some kind of action button to support master/details."
        )
      ])
    ])
  }
