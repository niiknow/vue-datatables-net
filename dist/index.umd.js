    ...
    methods: {
      ...
      compileTemplate(field, slot) {
        ...
        const renderFunc = (data, type, row, meta) => {
          const myDynamicComponent = vue.defineComponent({
            data() {
              return  {
                data: data,
                type: type,
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createElementBlock("div", {
      ...
      _cache[0] || (
        ...
        _cache[0] = vue.createElementVNode("table", {
          id: $data.tableId,
          ref: "table",
          ...
          vue.createElementVNode("thead", {
            ...
            vue.createElementVNode("tr", null, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.options.columns, (field, i) => {
          ...
          (!$props.hideTfoot)
            ? (vue.openBlock(), vue.createElementBlock("tfoot", {
                key: 0,
